...
export const metadata: Metadata = {
  ...
  description: '별똥별을 클릭해서 10을 만드는 무료 온라인 반응속도 게임! 60초 안에 최고 점수를 달성하고 친구와 경쟁하세요. PC와 모바일에서 모두 플레이 가능한 브라우저 게임입니다.',
  keywords: [
    '별똥별 게임',
    '반응속도 테스트',
    '반응속도 게임',
  ...
  openGraph: {
    ...
    description: '별똥별을 클릭해서 10을 만드는 무료 온라인 반응속도 게임! 60초 안에 최고 점수를 달성하고 친구와 경쟁하세요.',
    images: [
      {
        url: '/og-image.png',
        width: 1200,
